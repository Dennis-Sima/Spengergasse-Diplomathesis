...
- Dokumentation: In der Dokumentation footnote:[https://stripe.com/docs/api/] werden
...
- Dokumentation: Die Dokumentation footnote:[https://github.com/OpenFeign/feign] ist sehr umfangreich und bietet
...
- Dokumentation: Die Dokumentation footnote:[https://docs.oracle.com/javase/8/docs/api/?java/util/stream/Stream.html] enthält
...
- Dokumentation: Da die Dokumentation von Collections in der Kotlinlang Dokumentation footnote:[https://kotlinlang.org/docs/] vollständig ist,
...
- Dokumentation: Die Dokumentation von Groovy für den Umgang mit Collections footnote:[http://docs.groovy-lang.org/next/html/documentation/working-with-collections.html]
...
- Dokumentation: In der Dokumentation von Scala footnote:[https://www.scala-lang.org/api/2.12.5/scala/collection/immutable/List.html]
...
- Dokumentation: Die Dokumentation, die in dem Cursive Plugin von dem IntelliJ Marktplatz footnote:[https://plugins.jetbrains.com/plugin/8090-cursive]
...
in Clojure hingegen wird die Bibliothek postal footnote:[https://clojars.org/com.draines/postal] verwendet.
